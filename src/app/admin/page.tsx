...
const AdminPage = async () => {
  ...
  return (
    <div className="b-violet-500 mx-auto max-w-7xl flex flex-col space-y-14">
      <header className="b-amber-500 admin-header">
        {/* Logo */}
      ...
      <main className="b-amber-700 admin-main">
        <section className="b-sky-600 w-full space-y-4">
          <h1 className="header">Welcome 👋</h1>
          <p className="text-dark-700">Start the day with managing new appointments</p>
        </section>

        <section className="b-emerald-500 admin-stat">
